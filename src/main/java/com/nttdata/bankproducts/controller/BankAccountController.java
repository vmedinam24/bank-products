...
public class BankAccountController {
   ...
   *
   * @param cliendId    a string of client identifier
   * @return Client
   */
  @GetMapping("/client")
  public Client obtenerClient(@RequestParam String cliendId){
    return this.bankAccountService.obtenerClient(cliendId);
  }
}
